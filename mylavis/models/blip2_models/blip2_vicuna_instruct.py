...
class Blip2VicunaInstruct(Blip2Base):
    ...
    def __init__(
        ...
        #from mylavis.models.blip2_models.llama_transformers import LlamaTokenizer
        from mylavis.models.blip2_models.modeling_llama import LlamaForCausalLM
    ...
    def from_config(cls, cfg):
        ...
        qformer_text_input = cfg.get("qformer_text_input", True) #原来是True
